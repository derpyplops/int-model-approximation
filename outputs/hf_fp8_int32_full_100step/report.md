...
| split | metric | step 0 | step 100 | change |
| --- | ---: | ---: | ---: | ---: |
| train | logit L1 | 21690.1211 | 20694.7461 | -4.59% |
| train | logit L2 | 69.3689 | 66.4139 | -4.26% |
| eval | logit L1 | 22746.5664 | 23792.4609 | 4.60% |
| eval | logit L2 | 74.4146 | 77.0560 | 3.55% |
| eval | mean abs logit error | 0.149711 | 0.156595 | 4.60% |
| eval | per-matmul RMSE mean | 0.085885 | 0.085752 | -0.16% |

Final eval secondary metrics:

- KL divergence: `0.012645`
- cosine similarity: `0.999029`
...
This run answers the minimum empirical question with a real HF FP8 teacher: the int32/fixed-point student was trainable against the teacher's logits and intermediate matmul outputs, and the CSV/plots show whether the divergence moved over the short run. Because the student is a full-depth converted copy, remaining logit error is attributable to the fixed-point scheme, trainability, and optimization rather than an intentionally missing stack of transformer layers.
